...
<!--DEBUT :: LES META -->
    <meta charset="utf-8">
    <title>SIE:: Liste des participants à la COP 24</title>
    	<meta charset="utf-8">
...
<!--Espace d'affichage info dynamique telle que ERREUR! AVERTISSEMENT! ...etc -->
				...
				<!--button type="submit" class="btn btn-succes " id="btnassignation" name="btnassignation"><i class="fa fa-plus"></i> Assignation de modules </button -->
                 <a class="btn btn-primary" href="admin_cop24.php" role="button">Retour à la page de la COP24</a>
		...
		<script src="web_admin_participants_cop24.js"></script> 
