...
<?php 
	...
	if(!isset($_GET['idstruct']) OR $_GET['idstruct']==""){
		$_SESSION["errorType"] = "danger";
        $_SESSION["errorMsg"] = "AUCUN PARTICIPANTS....";
		redirect("admin_cop25.php");
		exit;		
	}

	// CONSERVER DANS LA VARIABLE SESSION LE ID DE LA STRUCTURE 
	// POUR LE RECUPER DANS LA PAGE DES PARTICIPANTSANTS REALISEES
	
	$_SESSION['structID'] = $_GET['idstruct'];
	mysql_select_db("cop25", $conbd_sie);
	
	$q = "SELECT * FROM participants WHERE idstructure ='".$structureId."'";
	$rs = mysql_query($q);
...
<!--DEBUT :: LES META -->
    <meta charset="utf-8">
    <title>SIE:: Administration - Gestion participants par structure de la COP 25</title>
    	<meta charset="utf-8">
...
<!--Espace d'affichage info dynamique telle que ERREUR! AVERTISSEMENT! ...etc -->
				...
				<!--button type="submit" class="btn btn-succes " id="btnassignation" name="btnassignation"><i class="fa fa-plus"></i> Assignation de modules </button -->
                 <a class="btn btn-primary" href="admin_cop25.php" role="button">Retour à la page de la COP25</a>
		...
		<script src="web_admin_participants_struct_cop25.js"></script> 
