...
<!--DEBUT :: LES META -->
    <meta charset="utf-8">
    <title>SIE:: Administration - Gestion de la COP 25</title>
    	<meta charset="utf-8">
...
<!--Espace d'affichage info dynamique telle que ERREUR! AVERTISSEMENT! ...etc -->
				...
				<!--button type="submit" class="btn btn-succes " id="btnassignation" name="btnassignation"><i class="fa fa-plus"></i> Assignation de modules </button -->
                 <a class="btn btn-primary" href="admin_participants_cop25.php" role="button">Gestion des participants</a>
                <a class="btn btn-primary" href="admin_suivi_activite_cop25.php" role="button">Suivi des activités de la COP</a>
		...
		<script src="web_admin_cop25.js"></script> 
