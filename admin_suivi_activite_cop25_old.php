...
<!--Espace d'affichage info dynamique telle que ERREUR! AVERTISSEMENT! ...etc -->
    			...
    			<div class="alert alert-<?php echo $ERROR_TYPE ?> alert-dismissable">
				 ...
				 <button type="submit" class="btn btn-default " id="btnadd_suiviCop" name="btnadd_suiviCop"><i class="fa fa-plus"></i> Ajouter une activité </button>
                
                 <br>
                 <br>
					<div class="container">
						<div class="row sie-layout-cell layout-item-1">
							<div class="col-sm-6">
								      <div class="form-group">
		<h5>Télécharger canevas chronogramme</h5>
        <div class="col-md-12  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-file"></i></span>
        <!--input type="file" class="form-control" name="chronogramme_canevas" id="chronogramme_canevas" /-->
		<input type="file" class="form-control" name="fichier_canvas" id="fichier_canvas" />
          </div><div id="uploaded_canevas"></div>
        </div>
      </div>  
	  <p>
	  <button type="button" class="btn btn-primary pull-right" id="btnsave_canevas" name="btnsave_canevas">Charger le canevas</button>
		 </p>					
							</div>
	
							<div class="col-sm-6">
							<button type="submit" class="btn btn-default " id="chrono_actu" name="chrono_actu"><i class="fa fa-plus"></i> Ajouter chronogramme actualisé </button>
								      <div class="form-group">
<h5>Télécharger chronogramme actualisé</h5>
        <div class="col-md-12  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-file"></i></span>
        <input type="file" class="form-control" name="chronogramme" id="chronogramme" />
          </div><div id="uploaded_chrono"></div>
        </div>
      </div>
	  <br>
	  <button type="button" class="btn btn-primary pull-right" id="btnsave_chrono" name="btnsave_chrono">Charger le fichier</button>
							</div>
					</div>
				</div>
					<br>
